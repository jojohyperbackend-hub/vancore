...
const statusColor = (s:string) => ({
  todo:"bg-stone-100 text-stone-400", progress:"bg-violet-100 text-violet-600",
  success:"bg-emerald-100 text-emerald-600", failed:"bg-red-100 text-red-400",
  active:"bg-violet-100 text-violet-600", completed:"bg-emerald-100 text-emerald-600",
  done:"bg-emerald-100 text-emerald-600",
  applied:"bg-blue-100 text-blue-500", screening:"bg-yellow-100 text-yellow-600",
  interview:"bg-violet-100 text-violet-600", offer:"bg-emerald-100 text-emerald-600",
  accepted:"bg-emerald-200 text-emerald-700", rejected:"bg-red-100 text-red-400",
  want:"bg-stone-100 text-stone-400", reading:"bg-violet-100 text-violet-600",
  dropped:"bg-red-100 text-red-400",
  watching:"bg-violet-100 text-violet-600", onhold:"bg-amber-100 text-amber-600",
  completed:"bg-emerald-100 text-emerald-600", plan:"bg-stone-100 text-stone-400",
  high:"bg-red-100 text-red-500", medium:"bg-amber-100 text-amber-600", low:"bg-stone-100 text-stone-400",
